...
- [API reference](/reference/api/) — route ownership + the shared backend conventions
- [Backend structure](/explanation/architecture/backend-structure#signals-computation) — where `build_signals` sits in the layering
- [Workspace model](/explanation/architecture/workspace-model) — the Hub / control plane these signals drive
