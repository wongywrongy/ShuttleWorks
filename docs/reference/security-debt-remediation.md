...
| DL-011 | Security golden-rules verification (2026-09-13) / SGR-20260913-K1 / R1, R3, R12 | No operator MFA; 30-day absolute session, no idle expiry or reauthentication for export, delete, role change, authority transfer, or display-token issue. SEC… | P08 | Implementation verified; review residuals closed 2026-09-14; independent review pending |
