...
- [Data flow → the three wired seams](/explanation/architecture/data-flow#the-three-wired-seams)
- [Bracket result command queue](/explanation/architecture/bracket-result-queue) · [ADR 0007 — Bracket result command queue](/explanation/decisions/0007-bracket-result-command-queue)
- [Bracket module](/reference/modules/bracket) · [Operations module](/reference/modules/operations)
