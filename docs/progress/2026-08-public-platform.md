...
It has produced two things this site documents in full: the [Entries module](/modules/entries)
(the operator's half, and the commit seam into the roster) and the
[entrant tier](/architecture/entrant-tier) (the public app under `/e/`).
...
[the entrant tier](/architecture/entrant-tier#the-three-hard-constraints).
...
- [Entries module](/modules/entries) · [Entrant tier](/architecture/entrant-tier) — what this program built
- [Progress reports](/progress/) — the board across all programs
