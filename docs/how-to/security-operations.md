...
| Display and invitation capabilities | Display management, workspace sharing and partner invitations | identity-module-owner | Revoke affected links and issue replacements. Staff links now expire within seven days, including existing links after migration 0003. Display expiry and hash-at-rest remediation for display/staff invitation links remain incomplete; nginx redaction does not close that storage gap. |
