    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Publish a demo review', link: '/how-to/publish-demo-review' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '0025 - SP-CONSOLE-6 program rulings', link: '/explanation/decisions/0025-sp-console-6-program-rulings' },
          { text: '0026 - SP-FIGMA-2 program rulings', link: '/explanation/decisions/0026-sp-figma-2-program-rulings' },
          { text: '0027 - Curated data components', link: '/explanation/decisions/0027-curated-data-components' },
          { text: '0028 - Entrant site port', link: '/explanation/decisions/0028-entrant-site-port' },
          { text: '0029 - State and formatting contract', link: '/explanation/decisions/0029-state-and-formatting-contract' },
        ],
      },
    ],
