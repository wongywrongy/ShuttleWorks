...
- **F-ARCH-1** (`fef1c3b`) — nav model relocated to `platform/product-shell`;
  `platform-no-app` ratcheted to error. → [ADR 0010](/explanation/decisions/0010-nav-model-in-platform).
...
- **F-ARCH-2/C** (`028a96e`) — shared `lib/disciplineNames`; bracket stops
  ...
  → [ADR 0011](/explanation/decisions/0011-cross-product-boundary-policy).
