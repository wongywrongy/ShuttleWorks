...
- [ADR 0003 — SQLite as primary persistence](../../explanation/decisions/0003-sqlite-as-primary-persistence.md)
  — the local-first decision, with its mirror clause marked superseded
- [ADR 0012 — Remove the Supabase mirror](../../explanation/decisions/0012-remove-the-supabase-mirror.md)
