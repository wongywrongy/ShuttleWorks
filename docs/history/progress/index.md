...
| **SP-CLOUD-3** | **Removed the Supabase mirror entirely** ([ADR 0012](/explanation/decisions/0012-remove-the-supabase-mirror)), plus the self-host deployment stack and the install docs walked literally end to end | **Complete** (2026-08-04) | `CLOUD_PROGRESS.md` |
...
- [The public platform (SP-PROGRAM-1)](/history/progress/2026-08-public-platform) — the current program:
  what the [Entries module](/reference/modules/entries) and the
  [entrant tier](/explanation/architecture/entrant-tier) do today, phase by phase, and what is still owed.
...
- [System overview](/explanation/architecture/system-overview) — what the programs above have produced
- [Decisions (ADRs)](/explanation/decisions/) — the durable *why* behind the shape they left
- [Quality attributes](/explanation/architecture/quality-attributes) — the properties every program has to preserve
