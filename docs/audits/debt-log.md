...
| **409 toast leaks internals** | conflict toast on the Run surface shows the raw match UUID + `request <id>` instead of the match code ("WS2") | Still open — S, map id→label at the toast call-site |
