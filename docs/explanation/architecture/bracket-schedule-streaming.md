...
[Scheduling unification](/explanation/architecture/scheduling-unification); this page
...
(see [Scheduling unification](/explanation/architecture/scheduling-unification)). The
...
- [Scheduling unification](/explanation/architecture/scheduling-unification) — the shared CP-SAT core under both modules
- [ADR 0006 — Unify the scheduling core; do not merge the match record](/explanation/decisions/0006-unified-scheduling-core)
