...
[ADR 0004](/explanation/decisions/0004-ortools-cpsat-engine) for the engine itself.
...
See [ADR 0006](/explanation/decisions/0006-unified-scheduling-core) for the decision
...
- [Bracket schedule streaming](/explanation/architecture/bracket-schedule-streaming) — the bracket's SSE + candidate-pool surface over this core
