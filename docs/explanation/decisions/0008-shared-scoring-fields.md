...
4. **The score *record* is deliberately not merged** —
   [ADR 0006](/explanation/decisions/0006-unified-scheduling-core) keeps Meet's integer
...
- [Unified configuration](/explanation/architecture/unified-configuration) (the shared field set + two-tab layout) ·
