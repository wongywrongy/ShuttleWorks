...
- **Positive** — the [signals](/reference/api/signals) layer still counts `comingSoon` modules (the
...
- [Workspace model → module status lifecycle](/explanation/architecture/workspace-model#module-status-lifecycle)
