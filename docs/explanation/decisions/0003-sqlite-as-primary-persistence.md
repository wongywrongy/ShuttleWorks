...
[ADR 0012](/explanation/decisions/0012-remove-the-supabase-mirror)** (2026-08-04).
...
See [ADR 0012](/explanation/decisions/0012-remove-the-supabase-mirror).
...
- [Data flow](/explanation/architecture/data-flow#the-outbox-and-the-cloud-mirror) · [Backend structure](/explanation/architecture/backend-structure)
