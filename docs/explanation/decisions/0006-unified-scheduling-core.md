...
solved by the same CP-SAT engine ([ADR 0004](/explanation/decisions/0004-ortools-cpsat-engine)).
...
- [Scheduling unification](/explanation/architecture/scheduling-unification) (the shared seam) ·
  [ADR 0004 — CP-SAT engine](/explanation/decisions/0004-ortools-cpsat-engine)
- Builds on this non-merge: [ADR 0007 — Bracket results through the command queue](/explanation/decisions/0007-bracket-result-command-queue) ·
  [ADR 0008 — Shared scoring fields](/explanation/decisions/0008-shared-scoring-fields)
