...
def test_basic_wins_losses():
    ...
    assert rows == [
        MeetStandingRowDTO(groupId="g1", groupName="Riverside", matchesPlayed=1, wins=1, losses=0),
        MeetStandingRowDTO(groupId="g2", groupName="Lakeside", matchesPlayed=1, wins=0, losses=1),
    ]
