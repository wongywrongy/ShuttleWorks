...
| 4 — Containers & migrations | not started | Exactly-once migrations + workers-wait; `docker-compose.cloud.yml`; Dockerfile COPY worker.py; docs env matrix; release-compose DATABASE_URL debt. |
