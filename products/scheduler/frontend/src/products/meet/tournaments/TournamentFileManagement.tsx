...
export function TournamentFileManagement() {
  ...
  return (
    ...
    >
        ...
        <div
          className={`rounded-sm p-2 text-sm ${
            message.type === 'success'
              ? 'bg-status-live-bg border border-status-live/30 text-status-live'
      ...
      {!hasData && (
        <div className="flex items-center gap-1.5 rounded-sm border border-status-warning/40 bg-status-warning-bg p-2 text-xs text-status-warning">
