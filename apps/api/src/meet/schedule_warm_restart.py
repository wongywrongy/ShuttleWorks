...
(``meet/schedule_proposals.py``, ``schedule_director.py``,
...
following the 410-with-a-pointer pattern in ``meet/schedule.py``.
"""
...
def _run_warm_restart(
    ...
    *,
    ...
    ``operations.match_state.build_locked_assignments(repo, tid)`` so
