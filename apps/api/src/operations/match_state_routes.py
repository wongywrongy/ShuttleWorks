...
(``operations.match_state.assert_valid_transition``). The PUT/DELETE
...
from core.schemas import MAX_SLOT_INDEX
...
# (handled in workspaces/tournaments.py) → owner.
...
def _precondition_failed(match_id: str, message: str) -> PreconditionFailedError:
    """Build the domain exception the 412 handler in core.main translates.
