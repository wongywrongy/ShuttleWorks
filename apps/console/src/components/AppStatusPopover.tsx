        ...
        >
          <div className="mb-2 flex items-center justify-between">
            ...
            <button
              ...
              className={`${INTERACTIVE_BASE} rounded border border-border px-2 py-0.5 text-xs text-muted-foreground hover:bg-muted/40 hover:text-foreground`}
          ...
          <div className="mt-3 flex items-center justify-between gap-2">
            <button
              ...
              aria-busy={backingUp}
              className={`${INTERACTIVE_BASE} rounded border border-border bg-card px-2 py-0.5 text-xs text-card-foreground hover:bg-muted/40 hover:text-foreground`}
            >
            ...
            <button
              ...
              className={`${INTERACTIVE_BASE} inline-flex items-center gap-1 rounded border border-border bg-card px-2 py-0.5 text-xs text-card-foreground hover:bg-muted/40 hover:text-foreground`}
            >
              Manage backups
