          ...
          {blocked.map((w, i) => (
            ...
            <li key={i} className="group flex items-center gap-1.5">
              ...
              <button
                ...
                className="shrink-0 rounded-sm p-1 text-muted-foreground transition-colors duration-fast ease-brand hover:bg-destructive/10 hover:text-destructive disabled:cursor-not-allowed disabled:opacity-50"
              >
                ×
              </button>
            </li>
