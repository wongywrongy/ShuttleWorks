...
import { BracketMatchControls } from '../BracketRunControls';
...
describe('BracketMatchControls', () => {
  it('shows Start button when assignment exists and not yet started', () => {
    render(<BracketMatchControls matchId="pu-1" data={DATA_WITH_MATCH} onChange={() => {}} />);
  ...
  it('calls matchAction with action=start when Start is clicked', async () => {
    ...
    render(<BracketMatchControls matchId="pu-1" data={DATA_WITH_MATCH} onChange={onChange} />);
