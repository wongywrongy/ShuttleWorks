/**
 * Pins the console NON_SCHEDULING_KEYS to the shared JSON the API
 * classifier loads (packages/shared-contract/non-scheduling-keys.json).
...
describe('non-scheduling keys parity', () => {
  it('console list matches the shared JSON', () => {
    const jsonPath = resolve(
      __dirname,
      '../../../../../packages/shared-contract/non-scheduling-keys.json',
    );
